...
import ru.vsu.cs.kunakhova_a_y.BuildYByX;
...
public class ArrayUtils {
    ...
    */
    ...
    public static int[] intToArray (int t) {
        int size = getSizeInt(t);
        int[] arr = new int[size];
        t = BuildYByX.buildYByXRecursive(t);
    ...
    public static int getSizeInt(int t) {
        int size = 0;
        while (t>0) {
            t/=10;
            size+=1;
